<%@ Page Title="Gestor cliente" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ABMCliente.aspx.cs" Inherits="tp_cuatrimestral_equipo_a1.ABMCliente" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="layoutAuthentication">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <asp:TextBox runat="server" ClientIDMode="static" TextMode="SingleLine" CssClass="form-control" ID="txtNombre" placeholder="Nombre" autocomplete="off" />
                                            <label for="txtNombre">Nombre</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <asp:TextBox runat="server" ClientIDMode="static" CssClass="form-control" ID="txtApellido" TextMode="SingleLine" placeholder="Apellido" autocomplete="off" />
                                ...
                                <div class="col-12 ">
                                    <div class="form-floating mb-3">
                                        ...
                                        <asp:TextBox runat="server" ClientIDMode="static" CssClass="form-control" ID="txtDocumento" placeholder="1234567" autocomplete="off"  />
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtDireccion" TextMode="SingleLine" placeholder="Direccion" autocomplete="off" />
                                            <label for="inputDireccion">Direccion</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <asp:TextBox runat="server" ClientIDMode="static" CssClass="form-control" ID="txtEmail" TextMode="Email" placeholder="nombre@ejemplo.com" autocomplete="off"  />
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid">
                                        <asp:Button Text="Crear Cliente" runat="server" class="btn btn-primary btn-block p-2" ID="btnAgregar" OnClientClick="return Validar()" OnClick="btnAgregar_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <%--MODAL--%>
        <div class="modal show" id="ModalConfirmar">
