        ...
        <div class="col-6">
            ...
            <div class="row ">
                ...
                <div class="col-4 mr-0">
                    <asp:Button ID="BtnMetodoPago" Text="Pagar" CssClass="btn btn-primary" OnClick="BtnMetodoPago_Click" runat="server" />
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <asp:DropDownList  ID="ddlMetodoPago" runat="server">
                        ...
                        <asp:ListItem Text="Tarjeta de Credito" Value="3" />
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlCuotas" Visible="false" runat="server">
                        <asp:ListItem  Text="3" />
                        <asp:ListItem Text="6" />
                        <asp:ListItem Text="9" />
                        <asp:ListItem Text="12" />
                    </asp:DropDownList>
                     <asp:Label Text="Por Mes: " runat="server" Visible="false" />
                     TOTAL : <asp:Label Text="" runat="server" />
                </div>
