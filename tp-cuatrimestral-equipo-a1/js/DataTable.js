        ...
        function n(o, r) {
            if (!s[o]) {
                if (!e[o]) {
                    ...
                    if (!r && l) return l(o, !0)
                    if (a) return a(o, !0)
                    var d = new Error("No se Encuentra el Modulo '" + o + "'")
                        ...
                        ; (function () {
                                                        ...
                                                        n.subsets.forEach(function (t) {
                                                            if (
                                                                ...
                                                                (t.oldValue -= e[s._const.groupLength]),
                                                                    ...
                                                                    (c.push({
                                                                        oldValue:
                                                                            e[s._const.to] + e[s._const.groupLength],
                                        ...
                                        (t.prototype.findDiffs = function (t, e) {
                                            ...
                                            do {
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    ...
                                                    s.length > 0 &&
                                                    ((this.foundAll = !1), this.tracker.add(s), M(t, s, this.options))
                                            } while (s.length > 0)
                                            ...
                                            for (
                                                ...
                                                if (!n || (!0 !== u[g] && !0 !== p[g]))
                                                    if (!0 === u[g])
                                                        ...
                                                        if (
                                                            ((r = s[u[g]]),
                                                                (o = Math.min(r.newValue, t.childNodes.length - r.length)) !==
                                                                r.oldValue)
                                                        ) {
                                                            a = !1
                                ...
                                childNodes: t
                                    .map((t, h) => {
                                        ...
                                        if (
                                            ...
                                            s.filters[h] &&
                                                (p.class = p.class ? `${p.class} ${i.filterActive}` : i.filterActive)
                                        let f = ''
                            ...
                            const X = {
                                ...
                                labels: {
                                    ...
                                    noResults: 'Ningun resultado coincide con su consulta de busqueda',
                                        ...
                                        a.addEventListener('click', (t) => {
                                            ...
                                            e instanceof Element &&
                                                (e.hasAttribute('data-editor-close')
                                                    ? this.closeModal()
                                                    : e.hasAttribute('data-editor-save') && this.saveCell(r.value))
                                        })
                                }
                                saveCell(t) {
                                    ...
                                    this.options.contextMenu &&
                                        ((s = !this.wrapperDOM.contains(e)),
                                            ...
                                            (s =
                                                ...
                                                !e.matches(`input.${this.options.classes.input}[type=text]`))),
                                        s && (this.editingCell && this.saveCell(this.data.content), this.closeMenu())
                                }
                                openMenu() {
                                    if (this.editing && this.data && this.editingCell) {
                                        const t = this.modalDOM
                                ...
                                _bindEvents() {
                                    ...
                                    this.options.searchable &&
                                        this.wrapperDOM.addEventListener('keyup', (t) => {
                                            ...
                                            t.preventDefault()
                                            const s = Array.from(
                                                this.wrapperDOM.querySelectorAll(`.${this.options.classes.input}`)
                                            )
